...
public class PwLoginActivity extends Activity implements OnClickListener{
				...
				if(sb.toString().equals(pwOld)){
					...
					if (settings.contains("sn")) {
						if (!settings.getString("sn", "").equals("")) {
							Intent intent = new Intent(PwLoginActivity.this,ConnectActivity.class);
						...
						startActivity(new Intent(PwLoginActivity.this,LoginServerActivity.class));
					}
					finish();
					if (Constants.LOG_SWITCH)
